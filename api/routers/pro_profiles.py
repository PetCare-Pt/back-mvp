...
from models.models import ProProfile, CreationResponse
...
@pp_router.post("/")
async def create_pro_profile(db: db_dependency, provider_id: user_id_dependency, pro_profile: ProProfile) -> CreationResponse:
...
async def update_pro_profile(db: db_dependency, provider_id: user_id_dependency, pro_profile_id: str, pro_profile: ProProfile) -> CreationResponse:
    pro_profile.provider_id = provider_id
